...
#git clone https://gitlab.com/simonpunk/susfs4ksu.git -b gki-android14-6.1-dev --depth=1
git clone https://gitlab.com/pershoot/susfs4ksu.git --depth=1 -b gki-android14-6.1
